    ...
    return Object.keys(wrestler.styles)[0]; // Fallback in case probabilities don't sum to 1
}
    ...
    'toproll': 12,
    'kings': 5
}[style] || 8; // Default fatigue cost of 8 if style unrecognized
    ...
    if (aiPicksOpponent) {
    opponentSelectContainer.style.display = 'none'; // Hide manual selection
    ...
    opponentSelectContainer.style.display = 'block'; // Show manual selection
}
}
    ...
    : wrestlers.slice(); // Copy of full array
